-- https://github.com/kism/mpvscripts/blob/1be4ac60f5c0eb40722142e56de907133acc32ef/scripts/vlcaspectratio.lua
-- Added a keybinding "reset_ar" to reset loop when i override the aspect ratio to start again from 16:9
...
mp.add_key_binding(nil, "reset_ar", function()
	cleanup()
	mp.osd_message("Aspect Ratio: Default")
end)
